...
author_craig_l_symonds = ReedsyInterviewFeed::Models::Author.create({ name: 'Craig L. Symonds' })
...
ReedsyInterviewFeed::Models::Book.create({ title: 'Antifragile: Things That Gain from Disorder' })

ReedsyInterviewFeed::Models::Book.create({ title: 'World War II at Sea: A Global History', author: author_craig_l_symonds })
